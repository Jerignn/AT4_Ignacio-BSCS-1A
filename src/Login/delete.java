...
public class delete extends javax.swing.JFrame {
    ...
    private static JSONParser jsonParser = login.jsonParser;
    private static JSONObject record = login.record;
    private static JSONArray userlist = login.userlist;
    public delete() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       for(int a = 0; a < userlist.size(); a++){
           ...
           JSONObject user = (JSONObject) userlist.get(a);
    ...
    public static void saveFile(){
        ...
        try(FileWriter writer = new FileWriter(filepath)){
            ...
            System.out.println("file not foundddd");
